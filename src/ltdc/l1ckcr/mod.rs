...
impl W {
    ...
    #[doc = "Bits 16:23 - Color Key Red value"]
    #[inline]
    pub fn ckred(&mut self) -> _CKREDW {
        _CKREDW { w: self }
    }
    #[doc = "Bits 8:15 - Color Key Green value"]
    #[inline]
    pub fn ckgreen(&mut self) -> _CKGREENW {
        _CKGREENW { w: self }
    }
    #[doc = "Bits 0:7 - Color Key Blue value"]
    #[inline]
    pub fn ckblue(&mut self) -> _CKBLUEW {
        _CKBLUEW { w: self }
    }
}
