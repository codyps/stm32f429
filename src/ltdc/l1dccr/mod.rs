...
impl W {
    ...
    #[doc = "Bits 24:31 - Default Color Alpha"]
    #[inline]
    pub fn dcalpha(&mut self) -> _DCALPHAW {
        _DCALPHAW { w: self }
    }
    #[doc = "Bits 16:23 - Default Color Red"]
    #[inline]
    pub fn dcred(&mut self) -> _DCREDW {
        _DCREDW { w: self }
    }
    #[doc = "Bits 8:15 - Default Color Green"]
    #[inline]
    pub fn dcgreen(&mut self) -> _DCGREENW {
        _DCGREENW { w: self }
    }
    #[doc = "Bits 0:7 - Default Color Blue"]
    #[inline]
    pub fn dcblue(&mut self) -> _DCBLUEW {
        _DCBLUEW { w: self }
    }
}
